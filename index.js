...
setTimeout(function(){
    client.on('ready', () => {
        ...
        console.log("─────────────────────────────────────────────────────────로그──────────────────────────────────────────────────────────");
            ...
            if(ss == 0){     
            client.user.setActivity("! MOON Server                                                                                  ", { url: 'https://www.twitch.tv/yosamonov1', type: 'STREAMING' });
            ss = ss + 1;
            }else{
                const xizy = client.users.cache.array().find(m => m.id === "755223361575059588")
...
client.on('message', message =>{
    ...
    if(message.channel.id !== "763204511040536616" && message.channel.id !== "763576915972849694" && message.channel.id !== "763580955428388894" && message.channel.id !== "763581062231490582" && message.channel.id !== "763581108646314026") return; 
    }
